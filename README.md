...
Green means one thing on a fund card: how well the fund fits. Only the fit band is filled with green - Moss for a strong fit, Algae for a good one, a wash of Algae on Moon for worth a look, a dashed Stone outline for limited evidence. Everything else on the card is a Stone outline: curating sits on white, and available money, a fund the project has already engaged with, and a fund that is not curating sit on Moon. None of those is the answer the card is for, so none of them borrows a second accent.
