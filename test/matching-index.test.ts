...
describe('matching index v2', () => {
  ...
  it('carries project and fund images without letting them reach the profile hash', async () => {
    ...
    const withoutImages = await buildMatchIndex(
      new FakeBubble(
        JSON.parse(
